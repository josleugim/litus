...
exports.post = function (req, res) {
    var data = {
        secrect: config.development.captchaSecrect,
        response: req.body['g-recaptcha-response'],
        remoteip: ip.address()
    };

    request.post({url: 'https://www.google.com/recaptcha/api/siteverify', headers:{'Content-type':'application/x-www-form-urlencoded'}, form: data}, function (err, response) {
        if(err) {
