...
module.exports = function (app) {
    ...
    app.get('/api/users/recover-notification', auth.requiresRole('user'), users.passRecoverNotification);
    app.get('/api/users/recover', auth.requiresRole('user'), users.passRecover);
